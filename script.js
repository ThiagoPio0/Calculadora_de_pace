...
function pace () {
    ...
    if (nome !== '' && peso !== '' && distancia !== '' && tempo !== '') {
        ...
        resultado.textContent = `Olá, ${nome}! Voce percorreu ${distancia}km em ${horas}h${minutos}min${segundos}s, o que implica em uma velocidade média de ${velocidade}km/h ou pace de ${pace}km/min. Estima-se que você tenha consumido ${calorias}calorias`;
